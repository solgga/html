...
// MVC 아키텍쳐에서 Model 역할 클래스. DB의 post 테이블 구조와 같은 클래스.
...
public class Post {
	...
	private LocalDateTime createdTime; // 컬럼 이름은 created_time 이라고 만들었지만 자바변수이름은 카멜표기로만들겟다.
	private LocalDateTime modifiedTime; // 얘도 컬럼이름은 modified_time 이라햇엇음
	...
	// builder 패턴
	public static PostBuilder builder() { // 외부 클래스
	...
	public static class PostBuilder { // 내부 클래스
		...
		public PostBuilder createdTime(LocalDateTime creDateTime) {
